//URL_SERVER = "http://129.213.121.67"
...
function direccionarPagina(id_pag){
    let page_name = ["barcos.html", "categorias.html", "clientes.html", "mensajes.html", "reservaciones.html"];
        ...
        if( page_name[id_pag] == "barcos.html" ){
            $.ajax({
                ...
                error : function(xhr, status) {
                    alert('Ha sucedido un problema en lectura de la tabla linea 19');
                },
                complete : function(xhr, status) {
                    console.log('Petición completada linea 22');
                }
            });
        }
    });
